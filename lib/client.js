...
var LIVE_STACK_MAX = 2;
var LIVE_LEAVE_MS = 560;
var LIVE_RECLAIM_MS = 700;
var LIVE_RECLAIM_STAGGER = 280;
var LIVE_RECLAIM_UNMOUNT_MS = LIVE_RECLAIM_MS + LIVE_RECLAIM_STAGGER * (LIVE_STACK_MAX - 1) + 220;
var LEAVE_MS = LIVE_LEAVE_MS;
var RECLAIM_MS = LIVE_RECLAIM_MS;
var RECLAIM_STAGGER = LIVE_RECLAIM_STAGGER;
...
var LiveThinkingCard = (0, import_react4.memo)(function LiveThinkingCard2({ text, step, running = true, state, style }) {
  ...
  const followActive = running && (state === void 0 || state === "enter" || state === "visible");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      style,
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dtt__reasoning-live-head", children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dtt__reasoning-live-title", children: [
            /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_dsh_client_ui_primitives2.IconThinkOutline14, { size: 13, "aria-hidden": true }),
            running ? "\u601D\u8003\u4E2D" : "\u5DF2\u601D\u8003"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("span", { className: "dtt__reasoning-live-step", children: [
            "\u6B65\u9AA4 ",
            step,
            running ? " \xB7 \u8FDB\u884C\u4E2D" : " \xB7 \u5DF2\u5B8C\u6210"
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          "div",
          {
            ...
            onPointerDown: () => {
              if (following && followActive) setFollowing(false);
            },
...
var LiveThinkingStack = (0, import_react4.memo)(function LiveThinkingStack2({ items, closing, compact }) {
  ...
  const reclaimTotal = (count) => motion ? RECLAIM_MS + RECLAIM_STAGGER * Math.max(0, count - 1) : 0;
  const [leaving, setLeaving] = (0, import_react4.useState)([]);
  const [reclaim, setReclaim] = (0, import_react4.useState)(null);
  const prevVisibleRef = (0, import_react4.useRef)([]);
  const prevItemsRef = (0, import_react4.useRef)(/* @__PURE__ */ new Map());
  ...
  const entries = items.map((item, index) => ({ key: String(index), item }));
  const visible = entries.slice(-LIVE_STACK_MAX);
  ...
  (0, import_react4.useLayoutEffect)(() => {
    ...
    if (evicted.length > 0) {
      const snapshots = evicted.map((key) => {
        const item = prevItemsRef.current.get(key);
        return item === void 0 ? void 0 : { key, item };
  ...
  (0, import_react4.useLayoutEffect)(() => {
    ...
    setLeaving([]);
    setReclaim(frozen);
    later(reclaimTotal(frozen.length) + 30, () => {
      setReclaim(null);
    });
  }, [closing, visibleKeys]);
  (0, import_react4.useEffect)(() => {
  ...
  if (reclaim !== null) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "dtt__reasoning-live-stack", "data-compact": compact || void 0, "data-closing": "true", "aria-live": "off", children: reclaim.map((entry, index) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      LiveSlot,
      {
        anim: "collapse",
        kind: "reclaim",
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
          LiveThinkingCard,
          {
            ...
            running: false,
            state: "reclaim",
            style: motion ? { animationDelay: `${index * RECLAIM_STAGGER}ms` } : void 0
          }
        )
      },
      entry.key
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: "dtt__reasoning-live-stack", "data-compact": compact || void 0, children: [
    leaving.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LiveSlot, { anim: "collapse", kind: "leave", motion, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      LiveThinkingCard,
      {
        text: entry.item.text,
        step: entry.item.step,
    ...
    visible.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(LiveSlot, { anim: "enter", motion, children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
      LiveThinkingCard,
      {
        text: entry.item.text,
        step: entry.item.step,
...
function ToolInputView({ name, args, raw }) {
  ...
  if ((name === "render_ui" || name === "show_widget") && typeof args.html === "string") {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.JsonTree, { data: args, label: "\u5DE5\u5177\u8F93\u5165", labels: JSON_LABELS })
    ] });
  }
  if (command !== void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("p", { className: `${NS3}__tnote`, children: "\u63D0\u4EA4\u7684\u547D\u4EE4" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.TerminalBlock, { command, cwd, labels: TERMINAL_LABELS }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("details", { className: `${NS3}__tall`, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.JsonTree, { data: args, label: "\u8F93\u5165\u5B57\u6BB5", labels: JSON_LABELS })
      ] })
    ] });
  }
  if (content !== void 0) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.ReadBlock, { label: target ?? "\u6587\u4EF6\u5185\u5BB9", lang: languageOf(target), lines: visible, totalLines: lines.length, maxLines: 16, labels: READ_LABELS }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("details", { className: `${NS3}__tall`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("summary", { children: "\u5168\u90E8\u8F93\u5165\u5B57\u6BB5" }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.JsonTree, { data: args, label: "\u8F93\u5165\u5B57\u6BB5", labels: JSON_LABELS })
      ] })
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.JsonTree, { data: args, label: raw === "" ? "\u8F93\u5165\u5C1A\u672A\u5230\u8FBE" : "\u5DE5\u5177\u8F93\u5165", labels: JSON_LABELS });
}
function ToolResultView({ name, category, block, text }) {
  ...
  if (category === "terminal") {
    ...
    const cwd = typeof args.workdir === "string" && args.workdir !== "" ? args.workdir : typeof args.cwd === "string" && args.cwd !== "" ? args.cwd : void 0;
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.TerminalBlock, { command, cwd, output, exitCode: facts.exitCode, signal: facts.signal, maxLines: 18, labels: TERMINAL_LABELS });
  }
  if (category === "read") {
    const window2 = readWindowOf(block);
    if (window2 !== null) {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.ReadBlock, { label: window2.path, lang: window2.lang, lines: window2.lines, totalLines: window2.totalLines, maxLines: 18, labels: READ_LABELS });
    }
  }
  if (category === "write") {
    const diffs = diffHunksOf(block);
    if (diffs !== null) return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.DiffBlock, { diffs, maxLines: 18, labels: DIFF_LABELS });
  }
  if (category === "search") {
    const view = searchViewOf(block);
    if (view !== null && view.shape === "paths") {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.SearchBlock, { kind: "paths", paths: view.paths, total: view.total, truncated: view.truncated, maxLines: 18, labels: SEARCH_LABELS });
    }
    if (view !== null && view.shape === "matches") {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.SearchBlock, { kind: "matches", files: view.files, total: view.total, truncated: view.truncated, maxLines: 18, labels: SEARCH_LABELS });
    }
  }
  if (category === "web") {
    const view = webViewOf(name, block);
    if (view !== null && view.shape === "fetch") {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.WebBlock, { kind: "fetch", url: view.url, statusCode: view.statusCode, truncated: view.truncated, labels: WEB_LABELS });
    }
    if (view !== null && view.shape === "search") {
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.WebBlock, { kind: "search", sources: view.sources, answer: view.answer, truncated: view.truncated, labels: WEB_LABELS });
    }
  }
  if (text !== "") {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: `${NS3}__tdoc`, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.MarkdownText, { text, streaming: false, labels: MD_LABELS }) });
  }
...
var SimpleToolRow = (0, import_react7.memo)(function SimpleToolRow2({
  ...
  const [tab, setTab] = (0, import_react7.useState)("result");
  ...
  const args = (0, import_react7.useMemo)(() => argFields(raw), [raw]);
  ...
  const tabs = (0, import_react7.useMemo)(() => [
    { id: "result", label: "\u7ED3\u679C" },
    { id: "input", label: "\u8F93\u5165" },
    { id: "raw", label: "\u539F\u59CB\u6570\u636E" }
  ], []);
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconChevronRightOutline14, { size: 13, "aria-hidden": true })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconChevronDownOutline14, { size: 14, "aria-hidden": true, className: `${NS3}__trow-chevron`, "data-open": open || void 0 })
            ]
          }
        ),
...
var ToolEntry = (0, import_react7.memo)(function ToolEntry2({
  ...
  const [deferredControl, setDeferredControl] = (0, import_react7.useState)(controlActive);
  (0, import_react7.useEffect)(() => {
    if (!controlActive) {
...
function useDrawerOpen(turn) {
  const store = activityStore();
  return (0, import_react10.useSyncExternalStore)(store.subscribe, () => store.openTurn === turn);
}
...
function ReasoningGroups({ items, activeIndex }) {
  const groups = (0, import_react10.useMemo)(() => groupReasoning(items), [items]);
  let cursor = 0;
...
function DrawerPanel({ turn, data, store, openFile, inspectCall, closing }) {
  ...
  const blocks = (0, import_react10.useMemo)(() => toolNodes.map((node) => node.data.root), [toolNodes]);
  const stats = (0, import_react10.useMemo)(() => computeStats(blocks), [blocks]);
  const kinds = (0, import_react10.useMemo)(() => kindByToolName(blocks), [blocks]);
  const close = () => {
    store.close();
  };
  const mode = store.activeMode;
  const [tab, setTab] = (0, import_react10.useState)(mode ?? (reasoning.length > 0 ? "reasoning" : "tools"));
  ...
  const toolsElapsed = (0, import_react10.useMemo)(() => {
    let earliest;
  ...
  const onScrollPin = (0, import_react10.useCallback)((event) => {
    const el = event.currentTarget;
  ...
  const [activeIndex] = (0, import_react10.useState)(null);
...
function DrawerApp() {
  const [openTurn, setOpenTurn] = (0, import_react10.useState)(null);
  const [lastTurn, setLastTurn] = (0, import_react10.useState)(null);
  const [openMode, setOpenMode] = (0, import_react10.useState)(null);
  const [data, setData] = (0, import_react10.useState)(void 0);
  ...
  const [reclaimPreview, setReclaimPreview] = (0, import_react10.useState)(null);
  const reclaimTimerRef = (0, import_react10.useRef)(void 0);
...
function EdgeView({ edge, marker }) {
  const d = (0, import_react11.useMemo)(() => roundedPath(edge.pts, 8), [edge]);
...
var DiagramCard = (0, import_react11.memo)(function DiagramCard2({ spec }) {
  const uid = (0, import_react11.useId)().replace(/:/g, "");
  const marker = "dg-arr-" + uid;
  const markerA = "dg-arrA-" + uid;
  const [mode, setMode] = (0, import_react11.useState)(spec.size === "compact" ? "compact" : "full");
...
var ProtoTabsCard = (0, import_react12.memo)(function ProtoTabsCard2({ spec }) {
...
function GeneratedImageStrip({ images, model }) {
  const [openIndex, setOpenIndex] = (0, import_react13.useState)(null);
  const [broken, setBroken] = (0, import_react13.useState)(/* @__PURE__ */ new Set());
  const [saveState, setSaveState] = (0, import_react13.useState)("idle");
...
function useGeneratedImages(toolNodes) {
  const scan = (0, import_react14.useMemo)(() => {
    const inline = [];
    const locators = [];
  ...
  const [spill, setSpill] = (0, import_react14.useState)(EMPTY2);
...
function ReasoningChip({ items, running, turn, thinkingStart, t, turnProcess, closed }) {
  ...
  const stackItems = (0, import_react15.useMemo)(() => items.filter((item) => item.text !== "").map((item) => ({ text: item.text, step: item.step, running: item.running })), [items]);
  const motion = useMotionAllowed(true);
  const [deferredControl, setDeferredControl] = (0, import_react15.useState)(controlActive);
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.IconChevronDownOutline14, { className: "dtt__process-chevron" })
            ]
          }
        ),
    ...
    switch (block.kind) {
      case "text": {
        const pushMd = (key, text) => {
          ...
          splitDiagram(text).forEach((sub, subIndex) => {
            if (sub.kind === "diagram") {
              ...
              rendered.push(
                /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Fresh, { live: streaming, freshKey: `${key}-md${subIndex}`, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.MarkdownText, { text: sub.text, streaming, labels, fileMentions: mentions }) })
              );
            }
          });
        };
        ...
        if (parts.length === 1 && parts[0]?.kind === "md" && parts[0].text.indexOf("diagram") < 0) {
          rendered.push(
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(Fresh, { live: streaming, freshKey: `md${index}`, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.MarkdownText, { text: block.text, streaming, labels, fileMentions: mentions }) })
          );
        } else {
...
var ThinkingStepNodeView = (0, import_react15.memo)(function ThinkingStepNodeView2(props) {
  ...
  const owner = (0, import_react15.useMemo)(() => {
  ...
  const mentions = (0, import_react15.useMemo)(
  ...
  const reasoningItems = (0, import_react15.useMemo)(() => steps.flatMap((step) => {
    const stepRunning = step.data.status === "running";
  ...
  const thinkingStart = (0, import_react15.useMemo)(() => {
    const runningStep = steps.find((step) => step.data.status === "running");
    return runningStep?.data.time;
  }, [steps]);
  const visibleBlocks = (0, import_react15.useMemo)(
  ...
  const gitVerbs = (0, import_react15.useMemo)(() => {
    const verbs = [];
  ...
  const gitDetail = (0, import_react15.useMemo)(() => [...new Set(gitVerbs)].join(" \xB7 "), [gitVerbs]);
  ...
  const cardMeta = (0, import_react15.useMemo)(() => {
  ...
  const labels = (0, import_react15.useMemo)(() => markdownLabelsFrom(t), [t]);
...
// src/client/retry/RetryShadowView.tsx
...
var RetryItem = (0, import_react16.memo)(function RetryItem2({ node, active, t }) {
  const deadline = (0, import_react16.useMemo)(() => Date.now() + node.delayMs, [node.delayMs, node.seq]);
  const scheduledSeconds = retrySeconds(node.delayMs);
  const maximum = node.mode === "normal" ? node.maxRetries : "\u221E";
  const [countdown, setCountdown] = (0, import_react16.useState)(() => ({
    deadline,
  ...
  (0, import_react16.useEffect)(() => {
    ...
    if (updateCountdown() === 1) return void 0;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("details", { className: "dtt__retry-row", "data-active": active || void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("summary", { className: "dtt__retry-summary", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "dtt__retry-text", role: "status", children: t("message.retry.status", { label, retry: node.retry, maximum, seconds }) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { className: "dtt__retry-details", children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "dtt__retry-detail-label", children: t("message.retry.delay") }),
        t("duration.milliseconds", { milliseconds: Math.round(node.delayMs) })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("span", { className: "dtt__retry-detail-label", children: t("message.retry.failure") }),
        failureMessage(node.failure.message, node.failure.code, t)
      ] })
    ] })
  ] });
});
var RetryShadowView = (0, import_react16.memo)(function RetryShadowView2(props) {
  const { node, t } = props;
  const loc = node.location;
  const closed = loc !== void 0 && (loc.kind === "turn" || loc.kind === "step") && loc.turn?.status === "closed";
...
function EditableText(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.group, children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.label, children: props.label }),
...
function ShotPanel({ closing, onClose, collect, title, cwd }) {
  const [range, setRange] = (0, import_react17.useState)("reply");
  const [theme, setTheme] = (0, import_react17.useState)(() => currentTheme());
  const [device, setDevice] = (0, import_react17.useState)("desktop");
  const [quality, setQuality] = (0, import_react17.useState)("2k");
  const [aspect, setAspect] = (0, import_react17.useState)("auto");
  ...
  return (0, import_react_dom2.createPortal)(
    /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.mask, "aria-hidden": "true", onClick: onClose }),
      /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.panel, "data-anim": anim, "data-editing": editing || void 0, role: "dialog", "aria-modal": "true", "aria-label": "\u5BF9\u8BDD\u622A\u56FE", children: [
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.head, children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.title, children: "\u5BF9\u8BDD\u622A\u56FE" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.close, "aria-label": "\u5173\u95ED", onClick: onClose, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("svg", { width: "15", height: "15", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: "M4 4l8 8M12 4l-8 8", stroke: "currentColor", strokeWidth: "1.6", strokeLinecap: "round" }) }) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.bar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.label, children: "\u8303\u56F4" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u622A\u56FE\u8303\u56F4", children: ["reply", "turn", "all"].map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.label, children: "\u7248\u5F0F" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u8BBE\u5907\u7248\u5F0F", children: Object.keys(DEVICE_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.label, children: "\u753B\u8D28" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u8F93\u51FA\u753B\u8D28", children: Object.keys(QUALITY_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.label, children: "\u753B\u5E45" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.seg, role: "group", "aria-label": "\u753B\u5E45\u6BD4\u4F8B", children: SHOT_ASPECTS.map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.group, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.label, children: "\u4E3B\u9898" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "select",
              {
                ...
                children: Object.keys(THEME_LABEL).map((item) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("option", { value: item, children: THEME_LABEL[item] }, item))
              }
            )
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.bar, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: cls2.meta, children: [
            "\u8F93\u51FA\u5BBD\u7EA6 ",
            preset.cssWidth * preset.scale,
            " px"
          ] })
        ] }),
        editing && editHtml !== null && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.editBar, children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.editHint, children: "\u70B9\u51FB\u9875\u9762\u4E0A\u7684\u5143\u7D20\u8FDB\u884C\u5220\u9664\uFF1B\u70B9\u51FB\u5DF2\u6807\u8BB0\u7684\u5143\u7D20\u53D6\u6D88\u6807\u8BB0" }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("span", { className: cls2.editCount, "data-n": marked > 0 ? "" : void 0, children: [
            "\u5DF2\u6807\u8BB0 ",
            marked,
            " \u4E2A"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.editSpacer }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.stage, children: /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.canvas, children: [
          busy && /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.hint, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: cls2.spinner }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { children: "\u6B63\u5728\u6E32\u67D3\u2026" })
          ] }),
          !busy && error !== null && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("div", { className: cls2.error, children: error }),
          !busy && error === null && (editing && editHtml !== null ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            "iframe",
            {
              ref: editorRef,
          ...
          ) : result !== null && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
            "img",
            {
              className: cls2.img,
              src: result.imageUrl,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.foot, children: [
          /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("span", { className: toast !== null ? `${cls2.meta} ${cls2.toast}` : cls2.meta, children: toast !== null ? toast : meta }),
          /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)("div", { className: cls2.actions, children: [
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.action, disabled: busy, onClick: () => {
              if (editing) stopEdit();
              run();
            }, children: "\u91CD\u65B0\u6E32\u67D3" }),
            result !== null && typeof result.html === "string" && !editing && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.action, disabled: busy, onClick: startEdit, children: "\u5143\u7D20\u5220\u9664" }),
            savedPath !== null && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.action, onClick: onCopyPath, children: "\u590D\u5236\u8DEF\u5F84" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.action, disabled: result === null, onClick: onCopy, children: "\u590D\u5236\u56FE\u7247" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
              "a",
              {
                className: cls2.action,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.action, onClick: () => {
              void reveal();
            }, children: "\u6253\u5F00\u76EE\u5F55" }),
            /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("button", { type: "button", className: cls2.primary, disabled: result === null, onClick: onSave, children: "\u4FDD\u5B58" })
          ] })
        ] })
      ] })
    ] }),
...
function CameraIcon() {
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", "aria-hidden": "true", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "8", cy: "9.25", r: "2.25", stroke: "currentColor", strokeWidth: "1.3" }),
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "12", cy: "6.75", r: "0.6", fill: "currentColor" })
  ] });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(import_jsx_runtime14.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      "button",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(CameraIcon, {})
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(ShotPanel, { closing, onClose: requestClose, collect, title, cwd })
  ] });
}
...
function mountShellChrome() {
  ...
  if (typeof setTimeout !== "undefined") {
    setTimeout(() => {
      if (!confirmed) postToParent({ type: "dsh:shell-hello" });
    }, 600);
    setTimeout(() => {
      if (!confirmed) postToParent({ type: "dsh:shell-hello" });
    }, 2e3);
