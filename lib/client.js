window.__ModuleLoader__.load({ id: "dsh-chat-plus", factory: (__rawRequire) => {
const require = (id) => {
...
var LiveDownloadCard = (0, import_react.memo)(function LiveDownloadCard2({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${NS}__card`, "data-state": status, "data-determinate": ratio !== null || void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: `${NS}__head`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_dsh_client_ui_primitives.IconDownloadOutlineRegular, { size: 14, "aria-hidden": true }),
...
// src/client/kr-chat/enabled.ts
var KR_CHAT_ENABLED = true;
var KR_PANEL_HEADER_VISIBLE = false;
...
var KrChatStore = class {
  constructor() {
    ...
    __publicField(this, "_activeTab", KR_CHAT_ENABLED ? "kr" : "chat");
      ...
      children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "span",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives2.IconChevronDownOutlineRegular, { size: 14, className: `${NS2}__process-chevron` })
          }
        )
      ]
    }
...
var CATEGORY_ICONS = {
  write: import_dsh_client_ui_primitives3.IconEditOutlineRegular,
  read: import_dsh_client_ui_primitives3.IconBrowseOutlineRegular,
  terminal: import_dsh_client_ui_primitives3.IconApiOutlineRegular,
  search: import_dsh_client_ui_primitives3.IconSearchOutlineRegular,
  web: import_dsh_client_ui_primitives3.IconSearchOutlineRegular,
  other: import_dsh_client_ui_primitives3.IconSparkleRegular
};
...
var SimpleToolRow = (0, import_react8.memo)(function SimpleToolRow2({
  ...
  const Icon = name === "skill" ? import_dsh_client_ui_primitives3.IconSkillOutlineRegular : CATEGORY_ICONS[category];
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives3.IconChevronRightOutlineRegular, { size: 13, "aria-hidden": true })
                }
              ),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives3.IconChevronDownOutlineRegular, { size: 14, "aria-hidden": true, className: `${NS3}__trow-chevron`, "data-open": open || void 0 })
            ]
          }
        ),
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__entry-wrap`, "data-reclaim": closed || void 0, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives3.IconChevronDownOutlineRegular, { size: 14, className: `${NS3}__process-chevron` })
        ]
      }
    ),
    ...
    showDownload && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__download-card`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__download-head`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives3.IconDownloadOutlineRegular, { size: 14, "aria-hidden": true }),
...
function DrawerToolSummary({ stats, cwd, openFile, kinds }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dts__summary", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dts__summary-title", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives4.IconApiOutlineRegular, { size: 13, "aria-hidden": true }),
      " \u5DE5\u5177\u8C03\u7528\u603B\u7ED3"
    ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("header", { className: "dts__modal-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dts__modal-title", children: [
          ...
          !showTabs && tab === "reasoning" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
            " \xB7 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives4.IconThinkOutlineRegular, { size: 14, "aria-hidden": true }),
            " ",
            reasoning.length
          ] }),
          !showTabs && tab === "tools" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
            " \xB7 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives4.IconApiOutlineRegular, { size: 14, "aria-hidden": true }),
            " ",
            toolNodes.length
          ] })
        ] }),
        showTabs && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dts__tabs", role: "tablist", "aria-label": "\u5206\u533A", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives4.IconThinkOutlineRegular, { size: 13, "aria-hidden": true }),
                " ",
                reasoning.length,
                " \u6B21\u601D\u8003"
              ]
...
function FlowCard({ variant, meta, interrupted, children }) {
  ...
  const krPanelLink = KR_CHAT_ENABLED && meta?.turnNumber !== void 0;
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
          "div",
          {
            ...
            title: krPanelLink ? `\u70B9\u51FB\u5728\u53F3\u4FA7\u5927\u76D8\u67E5\u770B\u7B2C ${meta.turnNumber} \u8F6E\u8BE6\u7EC6\u8F68\u8FF9` : void 0,
            style: { cursor: krPanelLink ? "pointer" : void 0 },
            children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives5.IconChevronDownOutlineRegular, { className: "dtt__process-chevron" })
            ]
          }
        ),
...
var ThinkingStepNodeView = (0, import_react16.memo)(function ThinkingStepNodeView2(props) {
  ...
  (0, import_react16.useEffect)(() => {
    if (pluginRenders && isFirstStep && reasoningItems.length > 0 && turnNumber2 !== void 0) {
      activityStore().setReasoning(turnNumber2, reasoningItems);
    }
  }, [pluginRenders, isFirstStep, reasoningItems, turnNumber2]);
  ...
  if (!pluginRenders && OfficialComp) {
    const defaultUsePresentation = (selector) => selector({
      mode: "detailed",
    ...
    const usePresentation = typeof props.usePresentation === "function" ? props.usePresentation : defaultUsePresentation;
    return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(OfficialComp, { ...props, usePresentation });
  }
 ...
 * \uFF08\u89C1 KrReasoningCard \u7684 REASONING_MAX_ROWS\uFF09\uFF0C\u884C\u9AD8 12px \xD7 1.6 = 19.2px\u3002
...
var KrTaskOverviewCard = (0, import_react19.memo)(function KrTaskOverviewCard2({
  tasks,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "kr-card kr-card--task", children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "kr-card__header", onClick: () => setCollapsed(!collapsed), children: [
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "kr-card__icon", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M13.328 9.7v1.28H7.28V9.7h6.048zM13.328 2.97v1.28H7.28V2.97h6.048z", fill: "currentColor" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M4.645 10.336a1.283 1.283 0 1 1-2.566 0 1.283 1.283 0 0 1 2.566 0zm1.28 0c0 1.415-1.148 2.563-2.563 2.563A2.563 2.563 0 0 1 .8 10.336c0-1.415 1.147-2.562 2.562-2.562 1.415 0 2.563 1.147 2.563 2.562z", fill: "currentColor" }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M4.645 3.612a1.283 1.283 0 1 1-2.565 0 1.283 1.283 0 0 1 2.565 0zm1.28 0C5.925 5.027 4.778 6.175 3.362 6.175A2.563 2.563 0 0 1 .8 3.612C.8 2.197 1.947 1.05 3.362 1.05c1.416 0 2.563 1.147 2.563 2.562z", fill: "currentColor" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "kr-card__title", children: "\u4EFB\u52A1\u6982\u89C8" }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: `kr-card__badge ${isRunning2 || activeCount > 0 ? "kr-card__badge--running" : "kr-card__badge--done"}`, children: progressText }),
      /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "kr-card__chevron", "data-collapsed": collapsed ? "true" : "false", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("path", { d: "M2.5 4.5 6 8 9.5 4.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
    ] }),
    !collapsed && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "kr-task-progress-line", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      "div",
      {
    ...
    !collapsed && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "kr-task-list", children: tasks.map((task, index) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "kr-task-item__icon", children: isCompleted ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", "aria-hidden": "true", children: [
              /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "7", cy: "7", r: "6.2", stroke: "currentColor", strokeWidth: "1.2" }),
            ...
            ] }) : isInProgress ? /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", style: { animation: "kr-spin 1.2s linear infinite" }, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "7", cy: "7", r: "6.2", stroke: "currentColor", strokeWidth: "1.2", strokeDasharray: "7 7" }) }) : /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("circle", { cx: "7", cy: "7", r: "6.2", stroke: "currentColor", strokeWidth: "1.2", strokeDasharray: "2.4 2.4" }) }) }),
            /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { className: "kr-task-item__content", children: task.content }),
            isInProgress && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("span", { className: "kr-task-item__tag kr-task-item__tag--running", children: "\u8FDB\u884C\u4E2D" })
          ]
        },
        task.id || index
      );
...
var REASONING_MAX_ROWS = 25;
var KrReasoningCard = (0, import_react20.memo)(function KrReasoningCard2({
  reasoningTexts,
  running
}) {
  const [collapsed, setCollapsed] = (0, import_react20.useState)(false);
  const motion = useMotionAllowed(true);
  const points = (0, import_react20.useMemo)(() => {
  ...
  const probe = (0, import_react20.useMemo)(() => `${running ? "1" : "0"}:${points.join("\0")}`, [points, running]);
  const followActive = running && !collapsed;
  const { ref, onScroll, onWheel, edges, overflow, following } = useSteppedFollow(probe, followActive, motion);
  if (reasoningTexts.length === 0 && !running) return null;
  const hasContent = points.length > 0;
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "kr-card kr-card--reasoning", children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { className: "kr-card__header", onClick: () => setCollapsed(!collapsed), children: [
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: "kr-card__icon", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { d: "M6 13h4M6.5 15h3M6 10.5c-.7-.7-1.5-1.7-1.5-3a4.5 4.5 0 1 1 9 0c0 1.3-.8 2.3-1.5 3-.5.5-.8 1.2-.8 2h-4.4c0-.8-.3-1.5-.8-2z" }) }) }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("span", { className: "kr-card__title", children: [
        "\u601D\u8003\u8FC7\u7A0B ",
        hasContent ? `(${points.length})` : running ? "(\u601D\u8003\u4E2D\u2026)" : ""
      ] }),
      followActive && overflow && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: "kr-card__follow", "data-following": following ? "true" : "false", children: following ? "\u8DDF\u968F\u4E2D" : "\u5DF2\u6682\u505C" }),
      /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { className: "kr-card__chevron", "data-collapsed": collapsed ? "true" : "false", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.6", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("path", { d: "M2.5 4.5 6 8 9.5 4.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
    ] }),
    !collapsed && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "kr-reasoning-list", children: hasContent ? /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
      "div",
      {
        className: "kr-reasoning-view",
        "data-edges": edges,
        "data-following": followActive && following ? "true" : void 0,
        ref,
        onScroll,
        onWheel,
        role: "region",
        ...
        style: { "--kr-reasoning-rows": REASONING_MAX_ROWS },
        children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "kr-reasoning-inner", children: points.map((item, idx) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { className: "kr-reasoning-row", children: /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { children: item }) }, idx)) })
      }
    ) : /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { color: "var(--dsw-alias-label-tertiary)" }, children: running ? "\u6B63\u5728\u6DF1\u5165\u63A8\u6F14\u9700\u6C42\u4E0E\u5B9E\u65BD\u65B9\u6848\u2026" : "\u672C\u8F6E\u65E0\u72EC\u7ACB\u601D\u8003\u8BB0\u5F55" }) })
  ] });
});
...
var TOOL_LIST_PREVIEW_COUNT = 5;
var KrToolCallsCard = (0, import_react21.memo)(function KrToolCallsCard2({
  tools,
  onInspectCall
}) {
  ...
  const [activeTabs, setActiveTabs] = (0, import_react21.useState)({});
  const [copiedKey, setCopiedKey] = (0, import_react21.useState)(null);
  const [showAllTools, setShowAllTools] = (0, import_react21.useState)(false);
  ...
  const renderToolIcon = (name) => {
    ...
    if (n.includes("code") || n.includes("bash") || n.includes("terminal") || n.includes("cmd") || n.includes("pwsh")) {
      return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "m4.5 5.5-3 3 3 3M11.5 5.5l3 3-3 3M9.5 3.5l-3 9" }) });
    }
    if (n.includes("read") || n.includes("browse") || n.includes("cat") || n.includes("view")) {
      return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2.5 3.5A1.5 1.5 0 0 1 4 2h8a1.5 1.5 0 0 1 1.5 1.5v9A1.5 1.5 0 0 1 12 14H4a1.5 1.5 0 0 1-1.5-1.5v-9z" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M5.5 5.5h5M5.5 8h5M5.5 10.5h3" })
      ] });
    }
    if (n.includes("edit") || n.includes("write") || n.includes("replace") || n.includes("patch")) {
      return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M11 2l3 3-8.5 8.5H2.5v-3L11 2z" }) });
    }
    if (n.includes("search") || n.includes("grep") || n.includes("find") || n.includes("glob")) {
      return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("circle", { cx: "6.5", cy: "6.5", r: "4.5" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "m10 10 3.5 3.5" })
      ] });
    }
    return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { viewBox: "0 0 16 16", width: "14", height: "14", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("circle", { cx: "8", cy: "8", r: "3" }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M8 1.5v2M8 12.5v2M1.5 8h2M12.5 8h2M3.4 3.4l1.4 1.4M11.2 11.2l1.4 1.4M3.4 12.6l1.4-1.4M11.2 4.8l1.4-1.4" })
    ] });
  };
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-card kr-card--tools", children: [
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-card__header", onClick: () => setCollapsed(!collapsed), children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "kr-card__icon", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "16", height: "16", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M14.7 10.8a2 2 0 0 0-2.8-2.8l-1.4 1.4-2.8-2.8 1.4-1.4a2 2 0 0 0-2.8-2.8L4.8 3.9a5 5 0 0 0-.9 5.3L1.2 12a1 1 0 0 0 1.4 1.4l2.8-2.7a5 5 0 0 0 5.3-.9l1.5-1.5z" }) }) }),
    ...
    !collapsed && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tools-list", children: [
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
                "div",
                {
                  ...
                  title: "\u70B9\u51FB\u5C55\u5F00/\u6536\u8D77\u8C03\u7528\u660E\u7EC6",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "kr-tool-icon", children: renderToolIcon(tool.name) }),
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "kr-tool-name", children: tool.name }),
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "kr-tool-detail", title: tool.description, children: tool.description }),
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "kr-tool-time", children: tool.durationText }),
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: `kr-tool-status ${isFailed ? "kr-tool-status--fail" : "kr-tool-status--done"}`, children: isFailed ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.6", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2.5 2.5l7 7M9.5 2.5l-7 7", strokeLinecap: "round" }) }) : isRunning2 ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.6", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("circle", { cx: "6", cy: "6", r: "4.5", strokeDasharray: "3 3" }) }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.6", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2.5 6.2 4.8 8.5 9.5 3.8", strokeLinecap: "round", strokeLinejoin: "round" }) }) }),
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: `kr-tool-row__chevron ${isExpanded ? "kr-tool-row__chevron--open" : ""}`, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "11", height: "11", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.8", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2.5 4.5 6 8 9.5 4.5", strokeLinecap: "round", strokeLinejoin: "round" }) }) })
                  ]
                }
              ),
              isExpanded && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail-panel", children: [
                /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail__ledger", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "kr-tool-detail__badge", children: [
                    "\u72B6\u6001: ",
                  ...
                  tool.exitCode !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: `kr-tool-detail__badge ${tool.exitCode !== 0 ? "kr-tool-detail__badge--err" : ""}`, children: [
                    "\u9000\u51FA\u7801: ",
                    tool.exitCode
                  ] }),
                  tool.signal && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { className: "kr-tool-detail__badge kr-tool-detail__badge--err", children: [
                    "\u4FE1\u53F7: ",
                    tool.signal
                  ] })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail__tabs", role: "tablist", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail__content", children: [
                  tab === "result" && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail__section", children: [
                    isFailed && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "kr-fail-card", style: { marginBottom: 8 }, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-fail-text", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("circle", { cx: "7", cy: "7", r: "5.5" }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M7 4.5v3M7 9.8h.01" })
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: tool.errorMessage || "\u5DE5\u5177\u8C03\u7528\u6267\u884C\u5931\u8D25" })
                    ] }) }),
                    tool.resultText ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-box", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-header", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u8F93\u51FA\u6587\u672C" }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                          "button",
                          {
                            type: "button",
                            ...
                            children: copiedKey === `res-${tool.id}` ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2 6.5 4.5 9 10 3" }) }),
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u5DF2\u590D\u5236" })
                            ] }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
                                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("rect", { x: "3.5", y: "3.5", width: "6.5", height: "6.5", rx: "1.2" }),
                                /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M8.5 3.5V2.2A1.2 1.2 0 0 0 7.3 1H2.2A1.2 1.2 0 0 0 1 2.2V7.3a1.2 1.2 0 0 0 1.2 1.2h1.3" })
                              ] }),
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u590D\u5236" })
                            ] })
                          }
                        )
                      ] }),
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("pre", { className: "kr-tool-code-pre", children: tool.resultText })
                    ] }) : !isFailed ? /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "kr-tool-empty-note", children: isRunning2 ? "\u6B63\u5728\u7B49\u5F85\u5DE5\u5177\u8FD4\u56DE\u6267\u884C\u7ED3\u679C\u2026" : "\u5DE5\u5177\u8C03\u7528\u5DF2\u6210\u529F\u8FD4\u56DE\uFF0C\u65E0\u7EAF\u6587\u672C\u8F93\u51FA\uFF08\u53EF\u80FD\u4E3A\u53EA\u8BFB\u6587\u4EF6\u52A0\u8F7D\u6216\u5916\u90E8\u64CD\u4F5C\uFF09\u3002" }) : null
                  ] }),
                  tab === "input" && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail__section", children: [
                    command && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-box", style: { marginBottom: 8 }, children: [
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-header", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u547D\u4EE4\u884C\u6267\u884C" }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                          "button",
                          {
                            type: "button",
                            ...
                            children: copiedKey === `cmd-${tool.id}` ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2 6.5 4.5 9 10 3" }) }),
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u5DF2\u590D\u5236" })
                            ] }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("pre", { className: "kr-tool-code-pre", style: { color: "var(--kr-accent)" }, children: [
                        "$ ",
                        command
                      ] })
                    ] }),
                    filePath && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-path-row", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { className: "kr-tool-path-label", children: "\u8DEF\u5F84:" }),
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("code", { className: "kr-tool-path-code", children: filePath })
                    ] }),
                    tool.argsRaw ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-box", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-header", children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u8F93\u5165\u53C2\u6570 JSON" }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                          "button",
                          {
                            type: "button",
                            ...
                            children: copiedKey === `arg-${tool.id}` ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2 6.5 4.5 9 10 3" }) }),
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u5DF2\u590D\u5236" })
                            ] }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                              /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("pre", { className: "kr-tool-code-pre", children: tool.argsRaw })
                    ] }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "kr-tool-empty-note", children: "\u65E0\u8F93\u5165\u53C2\u6570" })
                  ] }),
                  tab === "raw" && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { className: "kr-tool-detail__section", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-box", children: [
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-code-header", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u5B8C\u6574\u4E0A\u4E0B\u6587\u8F7D\u8377 (\u53EA\u8BFB)" }),
                      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                        "button",
                        {
                          type: "button",
                          ...
                          children: copiedKey === `raw-${tool.id}` ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2 6.5 4.5 9 10 3" }) }),
                            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u5DF2\u590D\u5236" })
                          ] }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                            /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "10", height: "10", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("pre", { className: "kr-tool-code-pre", children: tool.rawResultJson || tool.argsRaw || '{\n  "status": "ready"\n}' })
                  ] }) })
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { className: "kr-tool-detail__footer", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
                    "button",
                    {
                      type: "button",
...
${tool.resultText || tool.errorMessage || ""}`, e),
                      children: copiedKey === `all-${tool.id}` ? /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "11", height: "11", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M2 6.5 4.5 9 10 3" }) }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u5DF2\u590D\u5236\u5168\u90E8\u660E\u7EC6" })
                      ] }) : /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "11", height: "11", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("rect", { x: "3.5", y: "3.5", width: "6.5", height: "6.5", rx: "1.2" }),
                          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M8.5 3.5V2.2A1.2 1.2 0 0 0 7.3 1H2.2A1.2 1.2 0 0 0 1 2.2V7.3a1.2 1.2 0 0 0 1.2 1.2h1.3" })
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u590D\u5236\u660E\u7EC6" })
                      ] })
                    }
                  ),
                  tool.callId && onInspectCall && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
                    "button",
                    {
                      type: "button",
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("svg", { width: "11", height: "11", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: [
                          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("circle", { cx: "5", cy: "5", r: "3.5" }),
                          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M7.8 7.8 11 11" })
                        ] }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: "\u8F68\u8FF9\u5B9A\u4F4D" }),
                        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("svg", { width: "9", height: "9", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("path", { d: "M3.5 2.5h6v6M9.5 2.5l-6 6" }) })
                      ]
                    }
                  )
                ] })
      ...
      tools.length > TOOL_LIST_PREVIEW_COUNT && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { children: showAllTools ? "\u6536\u8D77" : `\u5C55\u5F00\u5176\u4F59 ${tools.length - TOOL_LIST_PREVIEW_COUNT} \u6B21\u8C03\u7528` }),
            /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(
              "svg",
              {
                width: "10",
...
var KrAgentPanel = (0, import_react22.memo)(function KrAgentPanel2({
  latestTurn,
  isTurnRunning,
  onCollapse
}) {
  const store = getKrChatStore();
  const krState = (0, import_react22.useSyncExternalStore)(
    (cb) => store.subscribe(cb),
    () => store.snapshot
  );
  const [snapTick, setSnapTick] = (0, import_react22.useState)(0);
  ...
  const [actTick, setActTick] = (0, import_react22.useState)(0);
  (0, import_react22.useEffect)(() => {
    return actStore.subscribe(() => setActTick((t) => t + 1));
  }, [actStore]);
  const [todoTick, setTodoTick] = (0, import_react22.useState)(0);
  (0, import_react22.useEffect)(() => {
    return subscribeLiveDshTodos(() => setTodoTick((t) => t + 1));
  }, []);
  const turnData = (0, import_react22.useMemo)(() => {
  ...
  const reasoningTexts = (0, import_react22.useMemo)(() => {
    return (turnData?.reasoning ?? []).map((r) => r.text).filter((t) => t.trim() !== "");
  }, [turnData, actTick, snapTick]);
  const tools = (0, import_react22.useMemo)(() => {
    return turnData?.tools ?? [];
  }, [turnData, actTick, snapTick]);
  const toolNames = (0, import_react22.useMemo)(() => {
    return tools.map((t) => {
      try {
  ...
  const tasks = (0, import_react22.useMemo)(() => {
  ...
  const subtitle = (0, import_react22.useMemo)(() => {
    if (tasks.length > 0) {
  ...
  const [shotOpen, setShotOpen] = (0, import_react22.useState)(false);
  ...
  const collectForShot = (0, import_react22.useCallback)((range) => {
    if (!latestChatSnapshot) return [];
    return collectMessages(latestChatSnapshot, displayTurn, range);
  }, [displayTurn]);
  const dialogueTitle = (0, import_react22.useMemo)(() => {
    const snap = latestChatSnapshot || (typeof window !== "undefined" ? window.__dshLatestChatSnapshot__ : null);
  ...
  const headerTitle = (0, import_react22.useMemo)(() => {
    if (dialogueTitle && dialogueTitle.trim() !== "") {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: `kr-split__side ${krState.fullscreen ? "kr-split__side--fullscreen" : ""}`, children: [
    KR_PANEL_HEADER_VISIBLE && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__header", children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "kr-panel__avatar", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("svg", { viewBox: "0 0 24 24", width: "18", height: "18", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("rect", { x: "4", y: "8", width: "16", height: "12", rx: "2" }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("path", { d: "M12 2v6M9 5h6M8 14h.01M16 14h.01M10 17h4" })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__titles", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__title-row", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: `kr-panel__status-dot ${currentRunning ? "kr-panel__status-dot--running" : ""}` }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { className: "kr-panel__title", title: headerTitle, children: headerTitle }),
          validSelectedTurn !== null && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("span", { style: { fontSize: 11, padding: "1px 6px", borderRadius: 4, background: "rgba(127, 127, 127, 0.12)", color: "var(--dsw-alias-label-secondary)", border: "1px solid var(--kr-card-border)", fontWeight: 500, flex: "none" }, children: "\u5DF2\u9009\u5BF9\u8BDD" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "kr-panel__subtitle", title: subtitle, children: subtitle })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
          "button",
          {
            ...
            title: "\u751F\u6210\u5BF9\u8BDD\u622A\u56FE",
            "aria-label": "\u751F\u6210\u5BF9\u8BDD\u622A\u56FE",
            children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 16 16", fill: "none", stroke: "currentColor", strokeWidth: "1.3", children: [
              /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
                "path",
                {
                  d: "M9.75 2.5H6.25L4.85 4.5H3C2.17 4.5 1.5 5.17 1.5 6V12.5C1.5 13.33 2.17 14 3 14H13C13.83 14 14.5 13.33 14.5 12.5V6C14.5 5.17 13.83 4.5 13 4.5H11.15L9.75 2.5Z",
              ...
              /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("circle", { cx: "8", cy: "9.25", r: "2.25" })
            ] })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
          "button",
          {
            ...
            title: "\u6536\u8D77\u53F3\u4FA7\u5927\u76D8",
            "aria-label": "\u6536\u8D77\u53F3\u4FA7\u5927\u76D8",
            children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("svg", { width: "14", height: "14", viewBox: "0 0 14 14", fill: "none", stroke: "currentColor", strokeWidth: "1.8", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("path", { d: "M2 2l10 10M12 2L2 12", strokeLinecap: "round" }) })
          }
        )
      ] })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__scroll", children: [
      !hasContent && !isViewingHistory && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__empty", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "kr-panel__empty-icon", children: /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("svg", { viewBox: "0 0 24 24", width: "26", height: "26", fill: "none", stroke: "currentColor", strokeWidth: "1.3", strokeLinecap: "round", strokeLinejoin: "round", children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("rect", { x: "4", y: "8", width: "16", height: "12", rx: "2" }),
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("path", { d: "M12 2v6M9 5h6M8 14h.01M16 14h.01M10 17h4" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "kr-panel__empty-title", children: "\u7B49\u5F85\u672C\u6B21\u5BF9\u8BDD\u5F00\u59CB" }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { className: "kr-panel__empty-desc", children: "\u53D1\u9001\u6D88\u606F\u540E\uFF0C\u4EFB\u52A1\u3001\u601D\u8003\u4E0E\u5DE5\u5177\u8C03\u7528\u4F1A\u5B9E\u65F6\u663E\u793A\u5728\u8FD9\u91CC" })
      ] }),
      validSelectedTurn !== null && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { className: "kr-panel__turn-hint", children: [
        /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: 220 }, title: dialogueTitle || "\u5DF2\u9009\u5BF9\u8BDD", children: [
          "\u5DF2\u9009\u5BF9\u8BDD\uFF1A",
          dialogueTitle || "\u5F53\u524D\u5BF9\u8BDD"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(KrTaskOverviewCard, { tasks, isRunning: currentRunning }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(KrReasoningCard, { reasoningTexts, running: currentRunning }),
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
        KrToolCallsCard,
        {
          tools: toolViews,
    ...
    shotOpen && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      ShotPanel,
      {
        closing: shotClosing,
...
function setClassIfDiff(el, className) {
  ...
  if (!btn || !btn.isConnected || btn.parentElement !== tablist) {
    ...
    btn.onclick = (e) => {
      ...
      try {
        ...
        const trajectoryBtn = Array.from(tablist.querySelectorAll('button[role="tab"]')).find((b) => b.id !== "kr-chat-tab-btn" && b.textContent?.trim() === "\u8F68\u8FF9");
        const isTrajectoryActive = trajectoryBtn?.getAttribute("aria-selected") === "true" || trajectoryBtn?.className.split(" ").includes(activeClass);
        if (isTrajectoryActive) {
          const chatBtn2 = Array.from(tablist.querySelectorAll('button[role="tab"]')).find((b) => b.id !== "kr-chat-tab-btn" && b.textContent?.trim() === "\u5BF9\u8BDD");
          chatBtn2?.click();
        }
      } finally {
        setTimeout(() => {
...
var KR_PANEL_ICON = '<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M12 2a2 2 0 0 1 2 2c0 .74-.4 1.38-1 1.72V7h4a3 3 0 0 1 3 3v8a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3v-8a3 3 0 0 1 3-3h4V5.72A2 2 0 0 1 10 4a2 2 0 0 1 2-2zm-5 7a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-8a1 1 0 0 0-1-1H7zm2 3a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3zm6 0a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3z"/></svg>';
function syncKrPanelToggle(tablist, isKr) {
  const store = getKrChatStore();
  let btn = document.getElementById("kr-panel-toggle-btn");
  if (!btn || !btn.isConnected || btn.parentElement !== tablist) {
    if (btn) {
      try {
        btn.remove();
...
function KrPanelSystem() {
  ...
  const [, setActTick] = (0, import_react23.useState)(0);
  (0, import_react23.useEffect)(() => {
    return activityStore().subscribe(() => setActTick((t) => t + 1));
  }, []);
  const [, setSnapTick] = (0, import_react23.useState)(0);
  (0, import_react23.useEffect)(() => {
    return subscribeLatestChatSnapshot(() => setSnapTick((t) => t + 1));
  }, []);
...
function mountKrChatController() {
  ...
  const syncDom = () => {
    ...
    if (lastRenderedSessionId !== latestChatSessionId) {
      ...
      if (panelRoot) {
        panelRoot.render(/* @__PURE__ */ (0, import_jsx_runtime18.jsx)(KrPanelSystem, {}));
      }
    }
