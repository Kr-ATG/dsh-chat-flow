...
function ReasoningGroups({ items, activeIndex, jumpToCategory }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dts__modal-reasoning", children: groups.map((group) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dts__modal-reasoning-group", "data-reasoning-category": group.category.label, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dts__modal-reasoning-group-title", role: "button", tabIndex: 0, onClick: () => jumpToCategory(firstIndex), children: [
        group.category.icon,
        " ",
...
function DrawerPanel({ turn, data, store, openFile, inspectCall }) {
  ...
  const thinkTextRef = (0, import_react6.useRef)(null);
  const toolsTextRef = (0, import_react6.useRef)(null);
  const [indicator, setIndicator] = (0, import_react6.useState)(null);
  const measureIndicator = (0, import_react6.useCallback)(() => {
  ...
  (0, import_react6.useLayoutEffect)(() => {
    measureIndicator();
  }, [measureIndicator, showTabs, reasoning.length, toolNodes.length]);
  (0, import_react6.useEffect)(() => {
    window.addEventListener("resize", measureIndicator);
    const fonts = document.fonts;
    if (fonts !== void 0) void fonts.ready.then(() => {
      measureIndicator();
    }).catch(() => {
    });
    return () => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "dts__modal-mask", onClick: close, "aria-hidden": true }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dts__modal", role: "dialog", "aria-label": `\u7B2C ${turn} \u8F6E\u6D3B\u52A8\u8BE6\u60C5`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("header", { className: "dts__modal-head", children: [
        ...
        showTabs && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: "dts__tabs", role: "tablist", "aria-label": "\u5206\u533A", ref: tabsRef, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
            "button",
            {
              ...
              children: [
                ...
                " ",
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { ref: thinkTextRef, children: [
                  "\u601D\u8003 ",
                  reasoning.length
                ] })
              ]
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconApiOutline14, { size: 13, "aria-hidden": true }),
                " ",
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { ref: toolsTextRef, children: [
                  "\u5DE5\u5177 ",
                  toolNodes.length
                ] })
              ]
          ...
          indicator !== null && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: "dts__tabs-indicator", "aria-hidden": true, style: { left: indicator.left, width: indicator.width } })
        ] }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dts__modal-scroll", ref: scrollRef, onScroll: onScrollPin, children: [
        tab === "reasoning" && reasoning.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dts__modal-panel", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ReasoningGroups, { items: reasoning, activeIndex, jumpToCategory: jumpTo })
        ] }),
