...
var CSS3 = [
  ...
  "body[data-ds-dark-theme] .dtt-diagram { border-color: rgba(255,255,255,.08) !important; box-shadow: 0 2px 10px rgba(0,0,0,.22) !important; }"
].join("\n");
...
var CSS4 = [
  ...
  "body[data-ds-dark-theme] .dtt-proto { border-color: rgba(255,255,255,.08) !important; box-shadow: 0 2px 10px rgba(0,0,0,.22) !important; }",
  "@media (prefers-reduced-motion: reduce) {",
...
var TurnProcessShadowView = (0, import_react3.memo)(function TurnProcessShadowView2(props) {
  ...
  const label = labels.length === 0 ? t("message.turnProcess.thoughtForAWhile") : labels.join(separator);
  const toggle = () => {
...
var NS3 = "dts";
function turnProcessSpecCounts(turnProcess) {
  const none = { messageCount: 0, subagentCount: 0 };
  ...
  const rec = spec;
  const num2 = (value) => typeof value === "number" && Number.isFinite(value) && value > 0 ? Math.floor(value) : 0;
  return { messageCount: num2(rec["messageCount"]), subagentCount: num2(rec["subagentCount"]) };
}
var EMPTY = [];
...
var ToolEntry = (0, import_react5.memo)(function ToolEntry2({
  ...
  const label = running ? elapsed !== void 0 ? `\u5DE5\u5177\u8C03\u7528\u4E2D \xB7 ${formatDuration(elapsed)}` : "\u5DE5\u5177\u8C03\u7528\u4E2D" : activity.reasoning > 0 ? `${resting}${separator}${activity.reasoning} \u6B21\u601D\u8003` : resting;
...
function DrawerPanel({ turn, data, store, anchor, openFile, inspectCall }) {
  ...
  const relayout = (0, import_react7.useCallback)(() => {
    ...
    if (box.bottom < 0 || box.top > viewportH) {
      ...
      store.close("anchor-out-of-view");
      return;
    }
    const MIN_H = 300;
    const MARGIN = 12;
...
function DrawerApp() {
  ...
  const [openMode, setOpenMode] = (0, import_react7.useState)(null);
  ...
  (0, import_react7.useEffect)(() => {
    ...
    const render2 = () => {
      ...
      setOpenTurn(turn);
      setOpenMode(turn === null ? null : store2.activeMode);
  ...
  drawerRoot.render(
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
      ErrorBoundary,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(DrawerApp, {})
      },
      gen
    )
  );
...
function DrawerChip({ turn, mode, label, value, title, onOpen }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "button",
    {
      ...
      onClick: (event) => {
        event.stopPropagation();
        onOpen(mode, event.currentTarget);
      },
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt__card-chip-label", children: label }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dtt__card-chip-value", children: value })
...
function FlowCard({ variant, meta, interrupted, turn, onOpenDrawer, children }) {
  if (variant === "step") {
  ...
  const drawerEntry = turn !== void 0 && onOpenDrawer !== void 0 ? { turn, onOpen: onOpenDrawer } : void 0;
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dtt__card-head", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dtt__card-chips", children: [
            ...
            drawerEntry !== void 0 && tools > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              DrawerChip,
              {
                turn: drawerEntry.turn,
                mode: "tools",
                label: "\u5DE5\u5177",
                value: String(tools),
                title: `\u67E5\u770B\u672C\u8F6E ${tools} \u6B21\u5DE5\u5177\u8C03\u7528`,
                onOpen: drawerEntry.onOpen
              }
            ),
            drawerEntry !== void 0 && thinking > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
              DrawerChip,
              {
                turn: drawerEntry.turn,
                mode: "reasoning",
...
var ReasoningRow = (0, import_react12.memo)(function ReasoningRow2({
  text,
  running,
  t
}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        import_dsh_client_ui_primitives5.DisclosureRow,
        {
          ...
          icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives5.IconThinkOutline14, { size: 14 }),
          ...
          collapsedContent: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(import_jsx_runtime10.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__reasoning-sep", "aria-hidden": "true" }),
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__reasoning-summary", "data-follow-end": running || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__reasoning-summary-text", children: summary }) })
          ] }),
          children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dtt__reasoning-body", children: text })
        }
      )
    }
  );
...
function useSearchableHidden(hidden, reveal2) {
  ...
  (0, import_react12.useEffect)(() => {
    const el = ref.current;
    if (el === null) return;
    el.addEventListener("beforematch", reveal2);
    return () => {
      el.removeEventListener("beforematch", reveal2);
    };
  }, [reveal2]);
  return ref;
}
function ProcessReasoning({
  ...
  const ref = useSearchableHidden(hidden, reveal2 ?? NOOP);
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { ref, "data-turn-process-inline": hidden || void 0, children });
}
    ...
    switch (block.kind) {
      case "text": {
        const pushMd = (key, text) => {
          ...
          splitDiagram(text).forEach((sub, subIndex) => {
            if (sub.kind === "diagram") {
              ...
              rendered.push(
                /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives5.MarkdownText, { text: sub.text, streaming, labels, fileMentions: mentions }, `${key}-md${subIndex}`)
              );
            }
          });
        };
        ...
        if (parts.length === 1 && parts[0]?.kind === "md" && parts[0].text.indexOf("diagram") < 0) {
          rendered.push(
            /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_dsh_client_ui_primitives5.MarkdownText, { text: block.text, streaming, labels, fileMentions: mentions }, index)
          );
        } else {
      ...
      case "reasoning":
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ProcessReasoning, { hidden: reasoningHidden, reveal: revealProcess, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
            ReasoningRow,
            {
              text: block.text,
      ...
      case "image": {
        ...
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_react13.Fragment, { children: renderMessageImages({
...
var ThinkingStepNodeView = (0, import_react12.memo)(function ThinkingStepNodeView2(props) {
  ...
  (0, import_react12.useEffect)(() => {
    if (!isFirstStep || turnNumber2 === void 0 || toolNodes.length === 0) return;
    const store = activityStore();
    store.setTools(turnNumber2, toolNodes, cwd, timing?.startTime);
    store.setHandlers({ openFile, inspectCall });
  }, [isFirstStep, turnNumber2, toolNodes, cwd, timing?.startTime, openFile, inspectCall]);
  ...
  const revealProcess = (0, import_react12.useCallback)(() => {
  ...
  const openDrawerFromCard = (0, import_react12.useCallback)((mode, el) => {
    if (turnNumber2 !== void 0) activityStore().open(turnNumber2, mode, { el });
  }, [turnNumber2]);
  if (!hasVisible && gallery === void 0) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "dtt__assistant", "data-streaming": streaming || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { className: "dtt__assistant-body", children: [
    rendered.length > 0 && (variant !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(FlowCard, { variant, meta: cardMeta, interrupted, turn: turnNumber2, onOpenDrawer: openDrawerFromCard, children: [
      rendered,
      gallery
    ...
    interrupted && variant === void 0 && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("span", { className: "dtt__stopped", children: "\u5DF2\u4E2D\u65AD" })
  ] }) });
});
