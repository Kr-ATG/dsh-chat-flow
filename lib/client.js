...
function useCanOpen(turn, counts) {
  const store = activityStore();
  const retained = (0, import_react5.useSyncExternalStore)(store.subscribe, () => store.get(turn));
  const retainedTools = retained?.tools !== void 0 ? retained.tools.length : 0;
  const retainedReasoning = retained?.reasoning !== void 0 ? retained.reasoning.length : 0;
...
var TurnProcessShadowView = (0, import_react5.memo)(function TurnProcessShadowView2(props) {
  ...
  const thinkingLabel = labels.length > 0 && thinkCount > 0 ? `${thinkCount} \u6B21\u601D\u8003` : void 0;
...
function DrawerApp() {
  ...
  const openTurnRef = (0, import_react10.useRef)(null);
  const closeTimerRef = (0, import_react10.useRef)(void 0);
  (0, import_react10.useEffect)(() => () => {
