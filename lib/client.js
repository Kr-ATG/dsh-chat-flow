...
/* \u2500\u2500 \u63D0\u95EE\u884C\uFF08tool.call.toolview / ask_user_question \u63A5\u7BA1\uFF09\uFF1A\u95EE\u7B54\u5361\u5E38\u9A7B \u2500\u2500\u2500\u2500
   ...
   \u300C\u63D0\u95EE \xB7 N/M \u5DF2\u56DE\u7B54\u300D\u4E00\u884C\u3002\u672C\u89C6\u56FE\u884C\u6837\u5F0F\u9010\u6761\u5BF9\u9F50\u5B98\u65B9 ToolRow\uFF08o3BgMG \u524D\u7F00\uFF09\uFF0C
...
// src/client/ask-question/AskRowView.tsx
...
function askT(real) {
  const fn = typeof real === "function" ? real : void 0;
  return (key, params) => {
    if (fn !== void 0) {
      try {
...
function answerEntries(text) {
  ...
  for (const item of parsed.answers) {
    ...
    if (!selected.every((entry) => typeof entry === "string")) return null;
    if (record.custom !== void 0 && typeof record.custom !== "string") return null;
    entries.push({ id: record.id, selected, ...record.custom === void 0 ? {} : { custom: record.custom } });
  }
  return entries;
}
function pairAnswers(questions, answers) {
  ...
  for (const question of questions) {
    ...
    const merged = [...answer.selected, ...answer.custom === void 0 || answer.custom === "" ? [] : [answer.custom]];
...
function singleResultText(block) {
  ...
  if (!isRecord(only) || only.type !== "text" || typeof only.text !== "string") return void 0;
  return only.text;
}
function rawBody(argsRaw, resultText2) {
  const args = parseJson(argsRaw);
  const argsText = args === void 0 ? argsRaw : JSON.stringify(args, null, 2);
  if (resultText2 === void 0) return argsText;
  const result = parseJson(resultText2);
  return `${argsText}

${result === void 0 ? resultText2 : JSON.stringify(result, null, 2)}`;
}
function Leading({ state }) {
  if (state === "error") return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.StateDot, { state: "error" });
  if (state === "stopped") return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.StateDot, { state: "warning" });
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_dsh_client_ui_primitives2.IconQuestionOutline14, {});
}
function AskCard({ transcript }) {
  if (transcript.kind === "unanswered") {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dtt__ask-card", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { className: "dtt__ask-verdict", children: transcript.verdict }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("ul", { className: "dtt__ask-list", children: transcript.questions.map((question) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("li", { className: "dtt__ask-question", children: question.question }, question.id)) })
    ] });
  }
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dl", { className: "dtt__ask-card", children: transcript.items.map((item) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dtt__ask-item", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dt", { className: "dtt__ask-question", children: item.question }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("dd", { className: "dtt__ask-answer", children: item.answers.length > 0 ? item.answers.map((answer) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dtt__ask-answer-line", children: answer }, answer)) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dtt__ask-skipped", children: transcript.skippedLabel }) })
  ] }, item.id)) });
}
function AskRowInner(props) {
  const { block } = props;
  ...
  const code = settled ? shape.error?.code : void 0;
  const baseState = !settled ? "running" : code === "interrupted" ? "stopped" : shape.isError === true ? "error" : "ok";
  const questions = (0, import_react3.useMemo)(() => questionEntries(argsRaw), [argsRaw]);
  const resultText2 = settled ? singleResultText(block) : void 0;
  const errorMessage = settled ? shape.error?.message : void 0;
  const presentation = (0, import_react3.useMemo)(() => {
    ...
    if (baseState === "ok") {
      const answers = resultText2 !== void 0 ? answerEntries(resultText2) : null;
  ...
  }, [baseState, code, errorMessage, questions, resultText2, t]);
  const body = open ? rawBody(argsRaw, resultText2) : "";
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dtt__ask-root", "data-state": presentation?.state ?? baseState, "data-tool": "ask_user_question", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
      import_dsh_client_ui_primitives2.DisclosureRow,
      {
        ...
        icon: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Leading, { state: presentation?.state ?? baseState }),
        ...
        collapsedContent: (presentation?.summary ?? "") !== "" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_jsx_runtime2.Fragment, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dtt__ask-sep", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dtt__ask-summary", children: presentation?.summary ?? "" })
        ] }),
        children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("pre", { className: "dtt__ask-raw", children: body })
      }
    ),
    presentation?.transcript !== null && presentation?.transcript !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AskCard, { transcript: presentation.transcript })
  ] });
}
function AskRowFallback(props) {
  const t = askT(props.t);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "dtt__ask-root", "data-state": "ok", "data-tool": "ask_user_question", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "dtt__ask-row dtt__ask-fallback", children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(Leading, { state: "ok" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "dtt__ask-title", children: t("ask.rowTitle") })
  ] }) });
}
var AskRowView = (0, import_react3.memo)(function AskRowView2(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(ErrorBoundary, { label: "ask row", fallback: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AskRowFallback, { ...props }), children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AskRowInner, { ...props }) });
});
...
var ICONS = {
  "git-push": /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
  ...
  "git-commit": /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("line", { x1: "3", y1: "12", x2: "9", y2: "12" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("line", { x1: "15", y1: "12", x2: "21", y2: "12" })
  ] }),
  "git-pull": /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }),
  ...
  "git-clone": /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { x: "8", y: "8", width: "14", height: "14", rx: "2" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2" })
  ] }),
  git: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("line", { x1: "6", y1: "3", x2: "6", y2: "15" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "18", cy: "6", r: "3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "6", cy: "18", r: "3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M18 9a9 9 0 0 1-9 9" })
  ] }),
  gh: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.403 5.403 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65-.17.6-.22 1.23-.15 1.85v4" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M9 18c-4.51 2-5-2-7-2" })
  ] }),
  install: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m7.5 4.27 9 5.15" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m3.3 7 8.7 5 8.7-5" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 22V12" })
  ] }),
  build: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m15 12-8.373 8.373a1 1 0 1 1-3-3L12 9" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m18 15 4-4" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m21.5 11.5-1.914-1.914A2 2 0 0 1 19 8.172V7l-2.26-2.26a6 6 0 0 0-4.202-1.756L9 2.96l.92.82A6.18 6.18 0 0 1 12 8.4V10l2 2h1.172a2 2 0 0 1 1.414.586L18.5 14.5" })
  ] }),
  test: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M10 2v7.527a2 2 0 0 1-.211.896L4.72 20.55a1 1 0 0 0 .9 1.45h12.76a1 1 0 0 0 .9-1.45l-5.069-10.127A2 2 0 0 1 14 9.527V2" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M8.5 2h7" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M7 16h10" })
  ] }),
  run: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("polygon", { points: "6 3 20 12 6 21 6 3" }),
  read: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
  ...
  write: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 20h9" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z" })
  ] }),
  edit: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m15 5 4 4" })
  ] }),
  delete: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
  ...
  fetch: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
  ...
  download: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("polyline", { points: "7 10 12 15 17 10" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("line", { x1: "12", y1: "15", x2: "12", y2: "3" })
  ] }),
  browser: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("polygon", { points: "16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76" })
  ] }),
  image: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" })
  ] }),
  vision: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "3" })
  ] }),
  memory: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("ellipse", { cx: "12", cy: "5", rx: "9", ry: "3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M3 5V19A9 3 0 0 0 21 19V5" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M3 12A9 3 0 0 0 21 12" })
  ] }),
  todo: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m3 17 2 2 4-4" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m3 7 2 2 4-4" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M13 6h8" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M13 12h8" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M13 18h8" })
  ] }),
  subagent: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 8V4H8" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { x: "4", y: "8", width: "16", height: "12", rx: "2" }),
  ...
  command: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("polyline", { points: "4 17 10 11 4 5" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("line", { x1: "12", y1: "19", x2: "20", y2: "19" })
  ] }),
  other: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" }),
  /* ── 思考分类（reasoning-classify 的 ReasoningIconKey）──────────────── */
  pen: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 20h9" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M16.376 3.622a1 1 0 0 1 3.002 3.002L7.368 18.635a2 2 0 0 1-.855.506l-2.872.838a.5.5 0 0 1-.62-.62l.838-2.872a2 2 0 0 1 .506-.854z" })
  ] }),
  "search-question": /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "11", cy: "11", r: "8" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m21 21-4.3-4.3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M11.5 17h.01" })
  ] }),
  check: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("circle", { cx: "12", cy: "12", r: "10" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m8.5 12.5 2.5 2.5 4.8-5.5" })
  ] }),
  clipboard: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("rect", { x: "8", y: "2", width: "8", height: "4", rx: "1" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M9 12h6" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M9 16h4" })
  ] }),
  scales: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M7 21h10" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M12 3v18" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2" })
  ] }),
  note: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M4 4h16v12l-4 4H4z" }),
    /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M16 20v-4h4" })
  ] }),
  chat: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_jsx_runtime3.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("path", { d: "M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" }) })
};
...
var TurnProcessShadowView = (0, import_react5.memo)(function TurnProcessShadowView2(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        drawerTab !== null ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          "span",
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives3.IconChevronDownOutline14, { className: `${NS2}__process-chevron` })
          }
        ) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_dsh_client_ui_primitives3.IconChevronDownOutline14, { className: `${NS2}__process-chevron` })
      ]
    }
  );
});
...
function KindBadge({ kind: kind2 }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: `${NS3}__badge`, "data-kind": kind2.key, title: kind2.label, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__badge-icon`, "aria-hidden": true, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(KindIcon, { kind: kind2.key, size: 12 }) }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__badge-text`, children: kind2.label })
  ] });
}
...
var SimpleToolRow = (0, import_react7.memo)(function SimpleToolRow2({
  block,
  selected,
  cwd,
  openFile,
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__dot`, "data-state": state, "aria-hidden": true }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__row-name`, children: name || block.callId }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(KindBadge, { kind: kind2 }),
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__row-summary`, title: summary, children: summary }),
              running && duration !== void 0 && activity === "download" && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: `${NS3}__row-live`, "data-kind": "download", title: "\u4E0B\u8F7D\u4E2D", children: [
              ...
              running && duration !== void 0 && activity === "command" && duration > 1e3 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: `${NS3}__row-live`, "data-kind": "command", title: "\u6267\u884C\u4E2D", children: [
                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__progress`, "aria-hidden": true }),
                /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { children: [
                  "\u6267\u884C\u4E2D \xB7 ",
                  formatDuration(duration)
              ...
              running && duration !== void 0 && !(activity === "download" || activity === "command" && duration > 1e3) && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { className: `${NS3}__row-time`, "data-running": true, title: "\u8017\u65F6", children: [
                "\u23F3 ",
                formatDuration(duration)
              ] }),
              !running && duration !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__row-time`, title: "\u8017\u65F6", children: formatDuration(duration) }),
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__chevron`, "data-open": open || void 0, "aria-hidden": true, children: "\u25B6" })
            ]
          }
        ),
        open && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__row-body`, children: [
          argsRaw !== "" && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__row-args`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__row-label`, children: "\u53C2\u6570" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("code", { children: argsRaw })
          ] }),
          output !== "" && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__row-output`, children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("span", { className: `${NS3}__row-label`, children: "\u8F93\u51FA" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("pre", { className: `${NS3}__row-pre`, children: output })
          ] }),
          argsRaw === "" && output === "" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: `${NS3}__row-empty`, children: running ? "\u6267\u884C\u4E2D\u2026" : "\u65E0\u8F93\u51FA" })
        ] })
      ]
    }
  );
...
function ToolCallTreeList({ block, cwd, openFile, inspectCall }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__drawer-call`, children: [
    ...
    block.subCalls.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: `${NS3}__subcalls`, "data-subcalls": true, children: block.subCalls.map((child) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(ToolCallTreeList, { block: child, cwd, openFile, inspectCall }, child.callId)) })
  ] });
}
var ToolEntry = (0, import_react7.memo)(function ToolEntry2({
  nodes,
  turn,
  turnStart,
  cwd,
  ...
  const stats = (0, import_react7.useMemo)(() => computeStats(nodes.map((node) => node.data.root)), [nodes]);
  ...
  const now = useNow(running);
  const toolStart = (0, import_react7.useMemo)(() => {
    let earliest;
  ...
  const liveActivity = (0, import_react7.useMemo)(() => {
  ...
  const liveDownloadCalls = (0, import_react7.useMemo)(
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__entry-wrap`, children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
      "button",
      {
        type: "button",
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconChevronDownOutline14, { className: `${NS3}__process-chevron` })
        ]
      }
    ),
    ...
    showDownload && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__download-card`, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: `${NS3}__download-head`, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_dsh_client_ui_primitives4.IconDownloadOutline16, { size: 14, "aria-hidden": true }),
...
var ToolGroupNodeView = (0, import_react7.memo)(function ToolGroupNodeView2(props) {
...
function useDrawerOpen(turn) {
  const store = activityStore();
  return (0, import_react8.useSyncExternalStore)(store.subscribe, () => store.openTurn === turn);
}
function DrawerToolSummary({ stats, cwd, openFile, kinds }) {
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dts__summary", children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dts__summary-title", children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives5.IconApiOutline14, { size: 13, "aria-hidden": true }),
      " \u5DE5\u5177\u8C03\u7528\u603B\u7ED3"
    ] }),
    ...
    stats.files.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dts__files", children: stats.files.map((path) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
      "button",
      {
        type: "button",
        className: "dts__file",
...
function ReasoningGroups({ items, activeIndex }) {
  const groups = (0, import_react8.useMemo)(() => groupReasoning(items), [items]);
  let cursor = 0;
      ...
      group.items.map((item) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dts__modal-reasoning-item-index", "aria-hidden": true, children: globalIndex + 1 }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { className: "dts__modal-reasoning-item-text", children: item.text })
            ]
          },
          globalIndex
        );
...
function DrawerPanel({ turn, data, store, anchor, openFile, inspectCall }) {
  ...
  const blocks = (0, import_react8.useMemo)(() => toolNodes.map((node) => node.data.root), [toolNodes]);
  const stats = (0, import_react8.useMemo)(() => computeStats(blocks), [blocks]);
  const kinds = (0, import_react8.useMemo)(() => kindByToolName(blocks), [blocks]);
  const close = () => {
    store.close();
  };
  const mode = store.activeMode;
  const [tab, setTab] = (0, import_react8.useState)(mode ?? (reasoning.length > 0 ? "reasoning" : "tools"));
  ...
  const toolsElapsed = (0, import_react8.useMemo)(() => {
    let earliest;
  ...
  const onScrollPin = (0, import_react8.useCallback)((event) => {
  ...
  const [activeIndex] = (0, import_react8.useState)(null);
  const popRef = (0, import_react8.useRef)(null);
  const [pos, setPos] = (0, import_react8.useState)(() => ({ top: 80, left: 1020, height: 480, tail: 10 }));
  const POPOVER_WIDTH = 480;
  const GAP = 8;
  const relayout = (0, import_react8.useCallback)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dts__popover-veil", onClick: close, "aria-hidden": true }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dts__popover", ref: popRef, role: "dialog", "aria-label": `\u7B2C ${turn} \u8F6E\u6D3B\u52A8\u8BE6\u60C5`, style: { top: anchorTop, left: anchorLeft, height: popHeight, ["--dts-pop-tail"]: `${popTail}px` }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("header", { className: "dts__modal-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dts__modal-title", children: [
          ...
          !showTabs && tab === "reasoning" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
            " \xB7 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives5.IconThinkOutline14, { size: 14, "aria-hidden": true }),
            " ",
            reasoning.length
          ] }),
          !showTabs && tab === "tools" && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
            " \xB7 ",
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives5.IconApiOutline14, { size: 14, "aria-hidden": true }),
            " ",
            toolNodes.length
          ] })
        ] }),
        showTabs && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { className: "dts__tabs", role: "tablist", "aria-label": "\u5206\u533A", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_dsh_client_ui_primitives5.IconThinkOutline14, { size: 13, "aria-hidden": true }),
                " ",
                reasoning.length,
                " \u6B21\u601D\u8003"
              ]
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dts__modal-close", onClick: close, "aria-label": "\u5173\u95ED", children: "\u2715" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { className: "dts__modal-scroll", ref: scrollRef, onScroll: onScrollPin, children: [
        ...
        reasoning.length === 0 && toolNodes.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dts__empty", children: "\u8FD9\u4E00\u8F6E\u6CA1\u6709\u53EF\u663E\u793A\u7684\u601D\u8003\u6216\u5DE5\u5177\u8C03\u7528" })
      ] })
    ] })
  ] });
}
function DrawerApp() {
  const [openTurn, setOpenTurn] = (0, import_react8.useState)(null);
  const [openMode, setOpenMode] = (0, import_react8.useState)(null);
  const [data, setData] = (0, import_react8.useState)(void 0);
  const [anchor, setAnchor] = (0, import_react8.useState)(void 0);
  (0, import_react8.useEffect)(() => {
  ...
  const store = activityStore();
  if (openTurn === null) {
    return preview === null ? null : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt__reasoning-live dts__preview", style: { position: "fixed", top: preview.top, left: preview.left, maxWidth: 520 }, "aria-live": "polite", children: preview.text });
  }
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("header", { className: "dts__modal-head", children: [
                ...
                /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { type: "button", className: "dts__modal-close", onClick: closeAll, "aria-label": "\u5173\u95ED", children: "\u2715" })
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dts__modal-scroll", children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dts__empty", children: "\u6C14\u6CE1\u6E32\u67D3\u5931\u8D25\uFF0C\u8BE6\u60C5\u89C1\u63A7\u5236\u53F0\uFF08F12\uFF09\u3002\u5173\u95ED\u540E\u6362\u4E00\u8F6E\u91CD\u5F00\u53EF\u91CD\u8BD5\u3002" }) })
            ]
          }
        ),
    ...
    preview !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { className: "dtt__reasoning-live dts__preview", style: { position: "fixed", top: preview.top, left: preview.left, maxWidth: 520 }, "aria-live": "polite", children: preview.text })
  ] });
}
var mounted = false;
var drawerRoot = null;
...
function FlowCard({ variant, meta, interrupted, turn, onOpenDrawer, children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { className: "dtt__card-head", children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("span", { className: "dtt__card-chips", children: [
            ...
            drawerEntry !== void 0 && tools > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              DrawerChip,
              {
            ...
            drawerEntry !== void 0 && thinking > 0 && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
              DrawerChip,
              {
                turn: drawerEntry.turn,
                mode: "reasoning",
...
function EdgeView({ edge, marker }) {
  const d = (0, import_react9.useMemo)(() => roundedPath(edge.pts, 8), [edge]);
...
var DiagramCard = (0, import_react9.memo)(function DiagramCard2({ spec }) {
  const uid = (0, import_react9.useId)().replace(/:/g, "");
  const marker = "dg-arr-" + uid;
  const markerA = "dg-arrA-" + uid;
  const [mode, setMode] = (0, import_react9.useState)(spec.size === "compact" ? "compact" : "full");
...
var ProtoTabsCard = (0, import_react10.memo)(function ProtoTabsCard2({ spec }) {
...
function GeneratedImageStrip({ images, model }) {
  const [openIndex, setOpenIndex] = (0, import_react11.useState)(null);
  const [broken, setBroken] = (0, import_react11.useState)(/* @__PURE__ */ new Set());
...
var ReasoningRow = (0, import_react13.memo)(function ReasoningRow2({
  text,
  running,
  t
}) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
        import_dsh_client_ui_primitives6.DisclosureRow,
        {
          ...
          icon: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.IconThinkOutline14, { size: 14 }),
          ...
          collapsedContent: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(import_jsx_runtime11.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "dtt__reasoning-sep", "aria-hidden": "true" }),
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "dtt__reasoning-summary", "data-follow-end": running || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "dtt__reasoning-summary-text", children: summary }) })
          ] }),
          children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "dtt__reasoning-body", children: text })
        }
      )
    }
  );
    ...
    switch (block.kind) {
      case "text": {
        const pushMd = (key, text) => {
          ...
          splitDiagram(text).forEach((sub, subIndex) => {
            if (sub.kind === "diagram") {
              ...
              rendered.push(
                /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.MarkdownText, { text: sub.text, streaming, labels, fileMentions: mentions }, `${key}-md${subIndex}`)
              );
            }
          });
        };
        ...
        if (parts.length === 1 && parts[0]?.kind === "md" && parts[0].text.indexOf("diagram") < 0) {
          rendered.push(
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(import_dsh_client_ui_primitives6.MarkdownText, { text: block.text, streaming, labels, fileMentions: mentions }, index)
          );
        } else {
      ...
      case "reasoning":
        rendered.push(
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(ProcessReasoning, { hidden: reasoningHidden, reveal: revealProcess, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
            ReasoningRow,
            {
              text: block.text,
...
var ThinkingStepNodeView = (0, import_react13.memo)(function ThinkingStepNodeView2(props) {
  ...
  const revealProcess = (0, import_react13.useCallback)(() => {
  ...
  const openDrawerFromCard = (0, import_react13.useCallback)((mode, el) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { className: "dtt__assistant", "data-streaming": streaming || void 0, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { className: "dtt__assistant-body", children: [
    rendered.length > 0 && (variant !== void 0 ? /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(FlowCard, { variant, meta: cardMeta, interrupted, turn: turnNumber2, onOpenDrawer: openDrawerFromCard, children: [
      rendered,
      gallery
    ...
    interrupted && variant === void 0 && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("span", { className: "dtt__stopped", children: "\u5DF2\u4E2D\u65AD" })
  ] }) });
});
...
function ShotPanel({ closing, onClose, collect, title, cwd }) {
  ...
  const [frameHeight, setFrameHeight] = (0, import_react16.useState)(null);
