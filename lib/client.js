    ...
    "button",
    {
      ...
      onClick: (event) => {
        if (drawerTab !== null) {
          ...
          const rect = (label2 ?? event.currentTarget).getBoundingClientRect();
...
function DrawerPanel({ turn, data, store, anchor, openFile, inspectCall }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { className: "dts__popover", role: "dialog", "aria-label": `\u7B2C ${turn} \u8F6E\u6D3B\u52A8\u8BE6\u60C5`, style: { top: anchorTop, left: anchorLeft, height: popHeight, ["--dts-pop-tail"]: `${Math.max(10, Math.min((anchor?.top ?? 80) - anchorTop + 4, popHeight - 40))}px` }, children: [
